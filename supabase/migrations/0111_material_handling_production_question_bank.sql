...
-- 0111_material_handling_production_question_bank.sql
--
...
create temporary table _seed_material_handling_l3_questions (
...
insert into _seed_material_handling_l3_questions (
  question_number,
  question_type,
  difficulty,
  prompt,
...
'Which behavior BEST demonstrates Level 3 proficiency in Material Handling?',
...
declare
  v_industry_id uuid;
  v_competency_id uuid := '347add3a-fde5-47f4-b350-860e5e8213df';
...
begin
  ...
  if not exists (
    ...
    raise exception 'Current Material Handling Master Competency not found';
  end if;
  ...
  v_assessment_name := 'Material Handling — Level 3 Competency Assessment';
  ...
  for v_row in
    select * from _seed_material_handling_l3_questions
  ...
  loop
    ...
    select
      ...
      'IntegrateU Material Handling L3 production assessment v1.0.',
      v_row.rationale
    where not exists (
      select 1
...
left join public.assessment_questions aq
 ...
 and aq.master_competency_template_id =
   '347add3a-fde5-47f4-b350-860e5e8213df'::uuid
