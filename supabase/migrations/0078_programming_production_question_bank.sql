...
-- 0078_programming_production_question_bank.sql
--
...
create temporary table _seed_programming_questions (
...
insert into _seed_programming_questions (
  question_number,
  question_type,
  difficulty,
  prompt,
...
declare
  ...
  v_competency_id uuid :=
    '34f3374a-52a5-4f5d-9151-cec8be6214f4';
...
begin
  ...
  -- --------------------------------------------------------------------------
  -- Validate current Programming competency
  -- --------------------------------------------------------------------------
  ...
  if not exists (
    ...
    raise exception
      'Current Programming Master Competency not found';
  ...
  -- --------------------------------------------------------------------------
  -- Reuse current Programming competency assessment.
  ...
  for v_row in
    ...
    select *
    from _seed_programming_questions
  ...
  loop
    ...
    select
      ...
      'IntegrateU Programming L3 production assessment v1.0.',
      v_row.rationale
...
production_questions as (
  ...
  join _seed_programming_questions s
