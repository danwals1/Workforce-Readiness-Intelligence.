...
-- 0066_team_leadership_production_question_bank.sql
--
...
--   -> Team Leadership competency assessment
...
create temporary table _seed_team_leadership_questions (
...
insert into _seed_team_leadership_questions (
  question_number,
  question_type,
  difficulty,
  prompt,
...
begin
  ...
  -- --------------------------------------------------------------------------
  -- Validate current Team Leadership competency
  -- --------------------------------------------------------------------------
  ...
  if not exists (
    ...
    raise exception
      'Current Team Leadership Master Competency not found';
  ...
  -- --------------------------------------------------------------------------
  -- Reuse current Team Leadership competency assessment.
  ...
  for v_row in
    ...
    select *
    from _seed_team_leadership_questions
  ...
  loop
    ...
    select
      ...
      'IntegrateU Team Leadership L4 production assessment v1.0.',
      v_row.rationale
...
production_questions as (
  ...
  join _seed_team_leadership_questions s
