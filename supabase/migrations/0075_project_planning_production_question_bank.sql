...
--   -> Project Planning competency assessment
...
create temporary table _seed_project_planning_questions (
...
insert into _seed_project_planning_questions (
  question_number,
  question_type,
  difficulty,
  prompt,
...
declare
  ...
  v_competency_id uuid :=
    'c9b136c8-c2c6-4324-8079-84076c77db46';
...
begin
  ...
  -- --------------------------------------------------------------------------
  -- Validate current Project Planning competency
  -- --------------------------------------------------------------------------
  ...
  if not exists (
    ...
    raise exception
      'Current Project Planning Master Competency not found';
  ...
  -- --------------------------------------------------------------------------
  -- Reuse current Project Planning competency assessment.
  ...
  for v_row in
    ...
    select *
    from _seed_project_planning_questions
  ...
  loop
    ...
    select
      ...
      'IntegrateU Project Planning L3 production assessment v1.0.',
      v_row.rationale
...
production_questions as (
  ...
  join _seed_project_planning_questions s
