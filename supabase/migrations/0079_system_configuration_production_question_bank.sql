...
-- 0079_system_configuration_production_question_bank.sql
--
-- Production Master Question Bank:
--   Competency: System Configuration
...
--   -> System Configuration competency assessment
...
create temporary table _seed_system_configuration_questions (
...
insert into _seed_system_configuration_questions (
  question_number,
  question_type,
  difficulty,
  prompt,
...
declare
  ...
  v_competency_id uuid :=
    'aabd433e-5307-4f02-a34f-c4060e6df1b4';
...
begin
  ...
  -- --------------------------------------------------------------------------
  -- Validate current System Configuration competency
  -- --------------------------------------------------------------------------
  ...
  if not exists (
    ...
    raise exception
      'Current System Configuration Master Competency not found';
  ...
  -- --------------------------------------------------------------------------
  -- Reuse current System Configuration competency assessment.
  ...
  for v_row in
    ...
    select *
    from _seed_system_configuration_questions
  ...
  loop
    ...
    select
      ...
      'IntegrateU System Configuration L3 production assessment v1.0.',
      v_row.rationale
...
production_questions as (
  ...
  join _seed_system_configuration_questions s
